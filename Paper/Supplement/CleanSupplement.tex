...
\caption{
Single patient trajectory without immune cells targeting premalignant cells.
}
\label{fig:1b_first}
\end{figure}
...
\caption{
Sample cohort survival curve without immune cells targeting premalignant cells.
}
\label{fig:1c_first}
\end{figure}
...
\caption{
Morris-OAT global sensitivity without immune cells targeting premalignant cells.
}
\label{fig:2_first}
\end{figure}
...
\caption{
Effects of mesenchymal tumor cell properties on the Time to Cancer without immune cells targeting premalignant cells.
}
\label{fig:3_first}
\end{figure}
...
\caption{
Effects of inflammation on the Time to Cancer without immune cells targeting premalignant cells.
}
\label{fig:4_first}
\end{figure}
...
\caption{
Summary of the contrasting effects of MIE and MGA on Time to Cancer without immune cells targeting premalignant cells.
}
\label{fig:5_first}
\end{figure}
