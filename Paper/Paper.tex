...
\rho_P = p(1+\delta_{P}\Delta_P)(1-\zeta \Delta_{MGA})\frac{K_0}{K_0+N_C}
\end{equation}
...
\rho_{NK} =\delta_{MUT} \frac{N_{NK}}{N_C/K_{1}+N_{NK}}  \frac{E_{NK}}{1+N_{Treg}/K_2} (1-\delta_{IE}\Delta_{IE})(1-\zeta \Delta_{MIE})
\end{equation}
...
\rho_R = 1 + \zeta p(1+\delta_P\Delta_P)\Delta_{MGA}\frac{K_0}{K_0+N_C}
\end{equation}
...
\tau_i = \frac{\tau_{max}}{N_C}\frac{1}{1+K_3/\tau}+ X_i
...
\tau = \tau_{MUT}N_{MUT} + \tau_{Treg}N_{Treg}
\end{equation}
