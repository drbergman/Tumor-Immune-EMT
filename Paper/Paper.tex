...
\par
The effects of the immune system on a tumor can be (very coarsely) summarized into two modules. Cytotoxic immune cells (such as natural killer (NK) cells and cytotoxic T cells (CTLs)) seek out and lyse tumor cells, whereas the regulatory branch of the immune system (which will below be accounted for by T regulatory cells (Tregs)), slows down the \tcr{effector functions} of these other cells. [REF]
...
\par 
While EMT has for some time been assumed to impact metastasis, more recently EMT-related phenotypes have been linked to other aspects of both tumor initiation and progression \cite{nieto2016emt}. In addition, TGF-$\beta$ is a master regulator of EMT [REF], thus tying it to the signaling networks involved in tumor-mediated immune responses, since Tregs release TGF-$\beta$ upon arriving at the tumor site\cite{terry2017new}. Thus, even by considering only a single signaling factor, we find these three components: the tumor, the immune system, and the EMT process to be inextricably linked. It thus strikes us as a priority to derive models to understand how interactions between each of these three components affect cancer incidence and progression.
\par 
Below we develop a multiscale model with this goal: to study interactions between the tumor, immune cells and EMT. Many 
...
% MODELS of cancer-immune 
%\cite{West19_JCOClinicalCancerInformatics}
...
\begin{figure}[H]
\center
\frame{\includegraphics[width=\columnwidth]{Figure2/Figure2.jpg}}
...
\begin{figure}[H]
\center
\frame{\includegraphics[width=\columnwidth]{Figure4/Figure4.pdf}}
...
\begin{figure}[H]
\center
\frame{\includegraphics[width=\columnwidth]{Figure5/MIEvsMQ.jpg}}
...
\begin{figure}[H]
\center
\frame{\includegraphics[width=\columnwidth]{FigTCGA.pdf}}
