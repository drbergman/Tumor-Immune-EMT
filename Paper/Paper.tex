...
\par
\tcr{Adam: Does this address what the y-axis is in Figure 2?}
...
\begin{enumerate}
     \item The first principle component of the \tcr{geneset}-wide expression is obtained for each element of the n-tuple of gene sets.
