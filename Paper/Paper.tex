...
This is because we have seen that the inflammatory state of the TME had some of the most significant effects on Time to Cancer (see Figures \ref{fig:MOAT} and \ref{fig:fig:VaryINFL_and_MesPars}BD).
