...
% More examples? Reviews or non-reviews? Explain some of the examples?
...
% Should I list out all parameter values? A subset? Or refer to supplement for base parameter values?
...
% It seems the rest of this paragraph belongs in the Methods section, yeah?
...
% This next commented out paragraph seems to belong somewhere, but where? I would think in the Intro.
...
It is at cell cycle number 541 the proportion of mutated cells reaches 50\% and so the patient has a Time to Cancer of 541, which translates to 405.75 days. % translate to days like this?
...
% is the above description sufficient? The first source is Morris's original paper and the second is the source of the particular implementation I found
...
% Is this next sentence necessary?
