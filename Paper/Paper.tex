...
In the right half of Figure \ref{fig:ModelIntro}A one can see the cell cycle choices that each cell will make each cell cycle and how the various components of the model will influence these probabilities.
