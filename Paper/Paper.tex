...
$\Delta_\text{MIE}$ &  mesenchymal immune evasion \\
 ...
 \hline
  $\Delta_A$ & \tcb{decrease in apoptosis rate in cells with driver mutation in apoptosis pathway}  \\ % should this and the others like it be more clear in stating this is not for all malignant cells, but only those with apoptosis pathway mutation? Better to be longer and unambiguous "decrease in apoptosis rate in cells with driver mutation in apoptosis pathway"
  \hline
