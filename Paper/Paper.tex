...
\section*{Abstract}
Preceding and during cancer progression, the immune system is engaged in complex sets of interactions with epithelia that affect tumor incidence and prognosis. Inflammation has particularly significant effects on gastrointestinal and pancreatic tumors.
...
Through {\em in silico} analyses of large patient cohorts, we found controllable regimes that maximise cancer-free survival. Delaying tumorigenesis depended crucially on properties of the mesenchymal phenotype: its growth rate and its immune-evasiveness.
